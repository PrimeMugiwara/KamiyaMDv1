...
const reply = (teks) => {
lenwy.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `❄️️ Halo Aku 「 Kamiya 汉 」`,"body": `Hai kak ${pushname} Jangan Spam Ya`, "previewType": "PHOTO","thumbnail": thumb,"sourceUrl": `https://whatsapp.com/channel/0029VaEvOpP35fLtqPxd4F2L`}}}, { quoted: len })}

const onlygc = () => {
lenwy.sendMessage(m.chat, {
    text: `❄️️ *Hello Im「 Kamiya 汉 」*\n⚠️ *Fitur Bot Hanya Bisa Digunakan Didalam Grup*\n\n🎁 *Mau Sc? Ketik Kamiya Di Grup*\n\n❄️️ *Information :*\n⨠ *Version : 1.2*\n⨠ *Author : 「 Kamiya 汉 」*\n⨠ *Author : wa.me/6283829102407*`,
    contextInfo: {
      externalAdReply: {
...
case 'sc':
case 'script': {
let buy = `❄️️ *Script Bot 「 Kamiya 汉 」 : 15K*
...
case 'bot': {
reply(`❄️️ *Bot 「 Kamiya 汉 」 Aktif*
🎁 *Author : wa.me/6283829102407*`)
}
break

case 'Kamiya': {
reply(`🍁 *Link Sc 「 Kamiya 汉 」 Ada Di Deskripsi : https://whatsapp.com/channel/0029VaEvOpP35fLtqPxd4F2L*`)
}
break
...
if (!q) return reply(`❄️️ *Contoh: ${prefix + command} 「 Kamiya 汉 」*`)
...
lenwy.sendMessage("6283829814737@s.whatsapp.net", {text:`❄️️ Sukses Bang...`})
}
break
case "pushkontakv2":
case "pv2":{
...
if (!q) return reply(`❄️️ *Halo Aku Adalah Program Yang Diciptakan Oleh Lenwy, Ada Yang Ingin Ditanyakan?*`)
reply('❄️️ *Sabar Yaa*')
...
case 'attp':
if (isBan) return reply('*Lu Di Ban Owner*')
if (args.length == 0) return reply(`❄️️ *Contoh: ${prefix + command} Lenwy*`)
ini_txt = args.join(" ")
...
case 'sewa':
if (isBan) return reply('*Lu Di Ban Owner*')
reply(`❄️️ *Harga Sewa Bot 「 Kamiya 汉 」*
...
case 'google': {
if (!q) return reply(`❄️️ *Contoh : ${prefix + command} Youtube Lenwy*`)
